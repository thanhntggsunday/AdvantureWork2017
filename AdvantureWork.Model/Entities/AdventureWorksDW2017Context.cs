...
{
    public partial class AdventureWorksDW2017Context : IdentityDbContext<AppUser, AppRole, Guid>
    {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer(SystemConstants.ConnectionString);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AppFunction>(entity =>
            {
                ...
                entity.ToTable("AppFunctions");
            });

            modelBuilder.Entity<AppFunction_Action>(entity =>
            {
                entity.HasKey(e => e.ID)
                    .HasName("PK_Function_ActionKey");

                entity.ToTable("AppFunction_Action");
            });

            modelBuilder.Entity<AppRole_Permission>(entity =>
            {
                entity.HasKey(e => e.ID)
                    .HasName("PK_Role_PermissionKey");

                entity.ToTable("AppRole_Permission");
            });
