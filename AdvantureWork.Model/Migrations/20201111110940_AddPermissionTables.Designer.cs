...
namespace AdvantureWork.Model.Migrations
{
    ...
    [Migration("20201111110940_AddPermissionTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvantureWork.Model.Entities.Action", b =>
                {
            ...
            modelBuilder.Entity("AdvantureWork.Model.Entities.Function", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AdvantureWork.Model.Entities.Function_Action", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdvantureWork.Model.Entities.Role_Permission", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdvantureWork.Model.Entities.Function_Action", b =>
                {
                    b.HasOne("AdvantureWork.Model.Entities.Action", "Action")
                        .WithMany("Function_Action")
                        .HasForeignKey("ActionId");

                    b.HasOne("AdvantureWork.Model.Entities.Function", "Functions")
                        .WithMany("Function_Action")
            ...
            modelBuilder.Entity("AdvantureWork.Model.Entities.Role_Permission", b =>
                {
                    ...
                    b.HasOne("AdvantureWork.Model.Entities.Function_Action", "Function_Action")
